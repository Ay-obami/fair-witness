...
const NAV_ITEMS = [
  ...
  { to: "/dashboard#safeguards", label: "Safeguards" },
    ...
    <nav className="border-b border-hairline">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-4 py-4 sm:flex-row sm:justify-between sm:px-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-3 text-sm sm:gap-x-6">
          ...
          <Link to="/signup" className="rounded-md bg-copper-500 px-4 py-1.5 text-xs font-semibold text-ledger-950 hover:bg-copper-400">New treasury</Link>
        </div>
      </div>
    </nav>
    {children}
